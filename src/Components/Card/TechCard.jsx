...
const TechCard = ({ title, tech }) => {
  return (
    <div className="text-d_primary dark:text-l_primary bg-l_secondary dark:bg-d_secondary">
        ...
        {tech.map((item, i) => {
          return (
            <div
              key={i}
              className={cn(
                "rounded-md  text-xs bg-slate-950 p-2",
                ...
                item === "Postman" && "border border-blue-500/60",
                item === "Auth0" && "border border-red-500/60",
                item === "Java" && "border border-yellow-500/60",
